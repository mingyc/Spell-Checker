...
void ParallelCompress(const std::string &inFileName, const std::string &outFileName);
void ParallelDecompress(const std::string &inFileName, const std::string &outFileName);
